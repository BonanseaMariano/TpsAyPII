...
public class Ej3 {
    ...
    public static void main(String[] args) {
        ...
        do {            
            ...
            if (num1>num2) {
                seleccion = JOptionPane.showOptionDialog(null, "El primer numero ("+num1+") es mayor:", "Resultado", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, opciones, opciones[0]);
            }else if (num1<num2) {
                seleccion = JOptionPane.showOptionDialog(null, "El segundo numero ("+num2+") es mayor:", "Resultado", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, opciones, opciones[0]);
            }else{
                seleccion = JOptionPane.showOptionDialog(null, "Ambos numeros son iguales:", "Resultado", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, opciones, opciones[0]);
            }
