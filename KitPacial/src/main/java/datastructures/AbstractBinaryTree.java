...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
     ...
     */
    public boolean full() {
        //El arbol posee unicamente la raiz
        if (left(root()) == null && right(root()) == null) {
            return true;
        }
        //El arbol posee mas que solo la raiz
        for (Position<E> p : positions()) {
            if (isExternal(p) && sibling(p) == null) {
                return false;
            }
        }
        return true;
    ...
    /**
     * Un árbol binario de expresiones contiene en sus nodos externos operandos
     * y en sus nodos internos operadores
     *
     * @param op lista de operadores válidos
     * @return retorna "true" si es árbol binario de expresiones o "false" en
     * caso contrario
     */
    public boolean validExpressionTree(List<E> op) {
        for (Position<E> p : positions()) {
            ...
            if (isExternal(p)) {
                //Los operadores siempre tienen hermanos
                if (sibling(p) == null) {
                    return false;
                }
                //El contenido del nodo externo no es un numero
                try {
                    Double.parseDouble((String) p.getElement());
     ...
     * Si el operando es una variable busca su valor en el Map v. Si la variable
     * no existe lanza la excepción: ArithmeticException indicando el nombre de
     * la variable que no existe.
     *
