...
public class ArrayList<E> implements List<E> {
     ...
     * <p>
     * This method iterates over the elements of the list using an iterator and removes each element
     * one by one until there are no more elements left.
     *
     * @throws UnsupportedOperationException if the iterator does not support the remove operation
     */
    public void clear() {
